                    ...
                    <div className='detail-right'>
                            ...
                            {product.isDiscount ?
                                <span className='product-detail-price'>
                                    <div className='discoutprice-top'>
                                        ...
                                        <span
                                            className='product-detail-realprice'>{product.price.toLocaleString()}원</span>
                                    </div>
                                    <span className='product-detail-discountprice'><span
                                        className='price-jabchae'>{product.discountPrice.toLocaleString()}</span>원</span>
                                </span>
                                :
                        ...
                        <div className='jaepum-choice'>
                            ...
                            <div className='brand-home'>
                                <span>
                                    브랜드 홈
                                    <svg width="14" height="14" fill="none" preserveAspectRatio="xMidYMid meet"><path
