  ...
  return (
    <header className="header">
      ...
      <div className="list">
        ...
        <span>
          <button id="store">스토어</button>
        </span>
        <span>
          <button id="move">이사/시공/수리</button>
        </span>
      </div>
      <div className="search">
        <input type="text" placeholder="스토어검색" id="searchbar" />
        <img src="images/search.jpg" id="search" />
      </div>
      <img src="images/cart.jpg" id="cart" />
